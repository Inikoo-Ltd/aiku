...
use App\Actions\Dropshipping\WooCommerce\CheckWooStatus;
...
Route::prefix('platform')->as('platform.')->group(function () {
    ...
    Route::post('wc-user/{customerSalesChannel}/check-status', CheckWooStatus::class)->name('wc.check_status');
...
Route::prefix('channels/{customerSalesChannel}')->as('customer_sales_channels.')->group(function () {
    ...
    Route::prefix('basket')->as('basket.')->group(function () {
        ...
        Route::patch('{order}/vatCheck', UpdateCustomerOrderTaxCategory::class)->name('vatCheck');
    });

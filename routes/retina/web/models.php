...
use App\Actions\Retina\Dropshipping\Orders\PayOrderWithBtree;
use App\Actions\Retina\Dropshipping\Orders\PayOrderWithPastpay;
use App\Actions\Retina\Dropshipping\Orders\PayOrderWithPaypal;
...
use App\Actions\Retina\Dropshipping\Portfolio\BulkUnlinkRetinaPortfolio;
...
use App\Actions\Retina\Fulfilment\Dropshipping\Portfolio\SyncRetinaStoredItemsFromApiProductsTiktok;
...
Route::post('orders/{order}/pay-by-btree', PayOrderWithBtree::class)->name('place_order_pay_by_btree');
Route::post('orders/{order}/pay-by-paypal', PayOrderWithPaypal::class)->name('place_order_pay_by_paypal');
...
Route::name('customer_sales_channel.')->prefix('customer-sales-channel/{customerSalesChannel:id}')->whereNumber('customerSalesChannel')->group(function () {
    ...
    Route::post('tiktok-sync-all-stored-items', SyncRetinaStoredItemsFromApiProductsTiktok::class)->name('tiktok_sync_all_stored_items');
...
Route::name('dropshipping.')->prefix('dropshipping')->group(function () {
    ...
    Route::post('{customerSalesChannel:id}/bulk-unlink-only', BulkUnlinkRetinaPortfolio::class)->name('bulk.unlink_only')->whereNumber('customerSalesChannel');

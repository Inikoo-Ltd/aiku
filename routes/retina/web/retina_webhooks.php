...
Route::name('webhooks.')->prefix('webhooks')->group(function () {
    Route::name('checkout_com.')->prefix('checkout-com')->group(function () {
        ...
        Route::post('redirect-success-paid-order/{Order}', RedirectSuccessPaymentOrder::class)->name('redirect_success_paid_order');
        ...
        //Route::post('order-payment-completed/{topUpPaymentApiPoint:ulid}', CheckoutComOrderPaymentSuccess::class)->name('order_payment_completed');

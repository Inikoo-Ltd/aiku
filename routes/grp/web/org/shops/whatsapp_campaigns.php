...
use App\Actions\Comms\WhatsappCampaign\StoreWhatsappCampaignRecipients;
...
Route::post('/{whatsappCampaign}/recipients', StoreWhatsappCampaignRecipients::class)->name('recipients.store');

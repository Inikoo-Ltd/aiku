...
use App\Actions\HumanResources\Overtime\UpdateEmployeeOvertimeRequest;
...
Route::post('/overtime-requests/{overtimeRequest}', UpdateEmployeeOvertimeRequest::class)->name('overtime_requests.update');

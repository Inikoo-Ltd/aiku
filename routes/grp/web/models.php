...
use App\Actions\Masters\MasterProductCategory\ChangeMasterSubDepartmentParent;
...
Route::patch('master-product-category/{masterProductCategory:id}/master-sub-department/parent', ChangeMasterSubDepartmentParent::class)->name('master_product_category.master_sub_department.parent.update');

 ...
 * @property mixed $co_orders
 * @property mixed $basket_score
 */
class IrisProductBasketRecommendationResource extends JsonResource
{
    use HasSelfCall;
    use HasPriceMetrics;
    ...
    public function toArray($request): array
    {
        ...
        return [
            ...
            'co_orders'                  => (int) $this->co_orders,
            'basket_score'               => round((float) $this->basket_score, 4),
        ];
    }
}

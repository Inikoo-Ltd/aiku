...
class CollectionTimeSeriesResource extends JsonResource
{
    public function toArray($request): array
    {
        ...
        return [
            ...
            'from' => $this->from,
            'to' => $this->to,
            'sales_external' => (float) $this->sales,
            'sales_org_currency_external' => (float) $this->sales_org_currency,
            'sales_grp_currency_external' => (float) $this->sales_grp_currency,

...
class DashboardTotalGroupMasterShopsSalesResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        ...
        $columns = array_merge(
            ...
            $this->getDashboardTableColumn($group->orderingIntervals, 'registrations_with_orders'),
            $this->getDashboardTableColumn($group->orderingIntervals, 'registrations_with_orders_delta'),
            $this->getDashboardTableColumn($group->orderingIntervals, 'registrations_without_orders'),
            $this->getDashboardTableColumn($group->orderingIntervals, 'registrations_without_orders_delta'),

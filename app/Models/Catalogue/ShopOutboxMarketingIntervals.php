 ...
 * Created: Tue, 31 Dec 2024 23:23:45 Malaysia Time, Kuala Lumpur, Malaysia
 ...
 *
 * @method static \Illuminate\Database\Eloquent\Builder<static>|ShopOutboxMarketingIntervals newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|ShopOutboxMarketingIntervals newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|ShopOutboxMarketingIntervals query()
 *
 * @mixin \Eloquent
 */
class ShopOutboxMarketingIntervals extends Model
{
    protected $table = 'shop_outbox_marketing_intervals';

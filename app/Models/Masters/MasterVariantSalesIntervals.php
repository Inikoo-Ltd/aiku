 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|MasterVariantSalesIntervals newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|MasterVariantSalesIntervals newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|MasterVariantSalesIntervals query()
 * @mixin \Eloquent
 */
class MasterVariantSalesIntervals extends Model
{
    protected $guarded = [];

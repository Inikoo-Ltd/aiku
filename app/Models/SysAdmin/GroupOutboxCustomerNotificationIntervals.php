 ...
 * Created: Tue, 31 Dec 2024 22:58:32 Malaysia Time, Kuala Lumpur, Malaysia
 ...
 *
 * @method static \Illuminate\Database\Eloquent\Builder<static>|GroupOutboxCustomerNotificationIntervals newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|GroupOutboxCustomerNotificationIntervals newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|GroupOutboxCustomerNotificationIntervals query()
 *
 * @mixin \Eloquent
 */
class GroupOutboxCustomerNotificationIntervals extends Model
{
    protected $table = 'group_outbox_customer_notification_intervals';

 ...
 * Created: Tue, 31 Dec 2024 22:58:40 Malaysia Time, Kuala Lumpur, Malaysia
 ...
 *
 * @method static \Illuminate\Database\Eloquent\Builder<static>|GroupOutboxMarketingNotificationIntervals newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|GroupOutboxMarketingNotificationIntervals newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|GroupOutboxMarketingNotificationIntervals query()
 *
 * @mixin \Eloquent
 */
class GroupOutboxMarketingNotificationIntervals extends Model
{
    protected $table = 'group_outbox_marketing_notification_intervals';

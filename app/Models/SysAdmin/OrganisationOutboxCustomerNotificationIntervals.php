 ...
 * Created: Tue, 31 Dec 2024 23:12:03 Malaysia Time, Kuala Lumpur, Malaysia
 ...
 *
 * @method static \Illuminate\Database\Eloquent\Builder<static>|OrganisationOutboxCustomerNotificationIntervals newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|OrganisationOutboxCustomerNotificationIntervals newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|OrganisationOutboxCustomerNotificationIntervals query()
 *
 * @mixin \Eloquent
 */
class OrganisationOutboxCustomerNotificationIntervals extends Model
{
    protected $table = 'organisation_outbox_customer_notification_intervals';

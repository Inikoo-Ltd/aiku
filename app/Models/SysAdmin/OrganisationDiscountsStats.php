 ...
 * @property int $number_current_offer_allowances
 * @property int $number_offer_allowances_state_in_process
 * @property int $number_offer_allowances_state_active
 * @property int $number_offer_allowances_state_finished

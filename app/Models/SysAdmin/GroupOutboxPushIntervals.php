 ...
 * Created: Tue, 31 Dec 2024 22:59:34 Malaysia Time, Kuala Lumpur, Malaysia
 ...
 *
 * @method static \Illuminate\Database\Eloquent\Builder<static>|GroupOutboxPushIntervals newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|GroupOutboxPushIntervals newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|GroupOutboxPushIntervals query()
 *
 * @mixin \Eloquent
 */
class GroupOutboxPushIntervals extends Model
{
    protected $table = 'group_outbox_push_intervals';

 ...
 * Created: Tue, 31 Dec 2024 23:11:39 Malaysia Time, Kuala Lumpur, Malaysia
 ...
 *
 * @method static \Illuminate\Database\Eloquent\Builder<static>|OrganisationOutboxColdEmailsIntervals newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|OrganisationOutboxColdEmailsIntervals newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|OrganisationOutboxColdEmailsIntervals query()
 *
 * @mixin \Eloquent
 */
class OrganisationOutboxColdEmailsIntervals extends Model
{
    protected $table = 'organisation_outbox_cold_emails_intervals';

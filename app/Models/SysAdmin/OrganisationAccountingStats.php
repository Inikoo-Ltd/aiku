 ...
 * @property numeric $customer_balances_org_amount
 * @property numeric $customer_positive_balances_org_amount
 * @property numeric $customer_negative_balances_org_amount

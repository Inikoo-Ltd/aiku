...
class ClockingsByDateSheet implements FromQuery, ShouldAutoSize, WithEvents, WithHeadings, WithMapping, WithStyles, WithTitle
{
    ...
    public function query(): Builder
    {
        ...
        if (!empty($this->employeeIds)) {
            $query->where('timesheets.subject_type', 'Employee')->whereIn('timesheets.subject_id', $this->employeeIds);
        }
    ...
    {
        return ['Date', 'Name', 'Job Position', 'Session #', 'Time', 'Action', 'Notes'];
    }

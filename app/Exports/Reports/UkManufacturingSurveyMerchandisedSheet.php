...
class UkManufacturingSurveyMerchandisedSheet extends DefaultValueBinder implements FromCollection, WithHeadings, WithTitle, ShouldAutoSize, WithCustomValueBinder
{
    ...
    public function collection(): Collection
    {
        $rows = DB::table('invoice_transactions as it')
            ...
            ->whereNotIn(DB::raw("LEFT(REPLACE(tu.tariff_code, ' ', ''), 6)"), $this->manufacturedTariffCodes)
        ...
        $collection->push(['', 'Total Merchanted Goods (Goods purchased for resale without processing)', '', number_format($total, 2, '.', '')]);

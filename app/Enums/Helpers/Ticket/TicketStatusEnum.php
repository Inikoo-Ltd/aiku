...
enum TicketStatusEnum: string
{
    ...
    public static function stateIcon(): array
    {
        return [
            ...
            'answered'    => ['tooltip' => __('Reporter replied'), 'icon' => 'fal fa-comment-dots', 'class' => 'text-amber-500', 'color' => 'amber'],
    ...
    public function group(): TicketStatusGroupEnum
    {
        return match ($this) {
            ...
            self::IN_PROGRESS, self::WAITING, self::ANSWERED, self::PENDING_DEPLOY => TicketStatusGroupEnum::IN_PROGRESS,

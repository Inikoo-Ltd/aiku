...
enum GroupDashboardSalesTableTabsEnum: string
{
    ...
    public function table(Group $group, array $organisationTimeSeriesStats = [], mixed $shopTimeSeriesStats = [], mixed $invoiceCategoryTimeSeriesStats = [], mixed $platformTimeSeriesStats = []): array
    {
        $header = match ($this) {
    ...
    public static function tables(Group $group, array $organisationTimeSeriesStats = [], mixed $shopTimeSeriesStats = [], mixed $invoiceCategoryTimeSeriesStats = [], mixed $platformTimeSeriesStats = []): array
    {
        return collect(self::cases())->mapWithKeys(function ($case) use ($group, $organisationTimeSeriesStats, $shopTimeSeriesStats, $invoiceCategoryTimeSeriesStats, $platformTimeSeriesStats) {
            return [$case->value => $case->table($group, $organisationTimeSeriesStats, $shopTimeSeriesStats, $invoiceCategoryTimeSeriesStats, $platformTimeSeriesStats)];
        })->all();
    }
}

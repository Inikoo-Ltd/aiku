...
class FetchAuroraDeliveryNote extends FetchAurora
{
    protected function parseModel(): void
    {
        ...
        if (! $this->auroraModelData->{'Delivery Note Order Key'}) {
            echo 'Warning delivery without order '.$this->auroraModelData->{'Delivery Note Key'}."  \n";
        ...
        if ($shop->type == ShopTypeEnum::FULFILMENT) {
            echo 'Ignore fulfilment delivery without order '.$this->auroraModelData->{'Delivery Note Key'}."  \n";
        ...
        if (! $order) {
            echo 'Delivery without invalid order key (not found) '.$this->auroraModelData->{'Delivery Note Order Key'}.' - '.$this->auroraModelData->{'Delivery Note Key'}."  \n";

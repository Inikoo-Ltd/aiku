 ...
 * Created: Monday, 23 Feb 2026 11:05:13 Central Indonesia Time, Sanur, Bali, Indonesia
...
class RunFavoriteOfferNotificationBulkRuns
{
    use AsAction;
    use WithGenerateEmailBulkRuns;
    use WithActionUpdate;

    public string $commandSignature = 'run:favorite-offer-notification';
    public string $jobQueue = 'default-long';

    public function tags(): array
    {
        return ['favorite_offer_notification'];
    }

    public function handle(): void
    {
        $queryOutbox = QueryBuilder::for(Outbox::class);
        $queryOutbox->whereIn('code', [OutboxCodeEnum::FAVORITE_OFFER_NOTIFICATION]);

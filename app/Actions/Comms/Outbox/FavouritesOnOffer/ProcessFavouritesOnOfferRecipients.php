...
class ProcessFavouritesOnOfferRecipients
{
    use AsAction;
            ...
            $dispatchedEmail = StoreDispatchedEmail::run(
                ...
                [
                    ...
                    'data->additional_data' => [
                        'favourites_on_offer_items' => $this->generateFavouritesContent($customer['product_ids']),
                    ]
                ]
            );
    ...
    public function generateFavouritesContent(string $productIds): string
    {
        $ids = array_slice(array_filter(explode(',', $productIds)), 0, self::MAX_ITEMS);

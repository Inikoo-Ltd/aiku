...
class IndexFulfilmentPickingSessionStoredItems extends OrgAction
{
    ...
    public function tableStructure(PickingSession $pickingSession, ?string $prefix = null): Closure
    {
        return function (InertiaTable $table) use ($pickingSession, $prefix) {
            ...
            if (in_array($pickingSession->state, [PickingSessionStateEnum::HANDLING, PickingSessionStateEnum::PICKING_FINISHED], true)) {

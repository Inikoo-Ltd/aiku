    ...
    public function htmlResponse(PalletReturn $palletReturn, ActionRequest $request): Response
    {
        ...
        if ($this->canEdit) {
            ...
            $actions = array_values(array_filter($actions, function (array $action): bool {
                return !in_array($action['key'] ?? null, ['in process', 'start picking', 'revert-to-picking', 'Dispatching', 'cancel-pallet-return', 'delete_dispatched', 'delete_return', 'set-to-picked', 'pdf'], true);
            }));
        }

    ...
    public function htmlResponse(PalletReturn $palletReturn, ActionRequest $request): Response
    {
        ...
        return Inertia::render(
            ...
            [
                ...
                'navigation'  => [
                    'previous' => ShowPalletReturn::make()->getPrevious($this->parent, $palletReturn, $request, true),
                    'next'     => ShowPalletReturn::make()->getNext($this->parent, $palletReturn, $request, true),
                ],
                'pageHead'    => [
                    // 'container' => $container,

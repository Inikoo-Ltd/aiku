...
class UpdateCustomer extends OrgAction
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'delivery_address'                                      => ['sometimes', 'nullable', new ValidAddress(requireFullAddress: !$this->asAction)],
            ...
            'email_subscriptions.is_subscribed_to_favourites_on_offer' => ['sometimes', 'boolean'],

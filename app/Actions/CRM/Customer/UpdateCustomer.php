...
class UpdateCustomer extends OrgAction
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'contact_address'                                       => ['sometimes', 'required', new ValidAddress(requireFullAddress: true)],
            'delivery_address'                                      => ['sometimes', 'nullable', new ValidAddress(requireFullAddress: true)],

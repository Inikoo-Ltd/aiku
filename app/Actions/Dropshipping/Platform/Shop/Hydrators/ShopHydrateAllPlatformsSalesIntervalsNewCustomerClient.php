...
class ShopHydrateAllPlatformsSalesIntervalsNewCustomerClient implements ShouldBeUnique
{
    use AsAction;
    ...
    public function handle(Shop $shop, ?array $intervals = null, ?array $doPreviousPeriods = null): void
    {
        ...
        foreach ($platformIds as $platformId) {
            ShopHydratePlatformSalesIntervalsNewCustomerClient::run($shop, $platformId, $intervals, $doPreviousPeriods);
        }
    }
}

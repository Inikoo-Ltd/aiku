...
class FetchCancelledAllegroOrders extends RetinaAction
{
    use WithActionUpdate;

    public string $commandSignature = 'allegro:fetch-cancelled-orders';
    ...
    public function handle(): void
    {
        ...
        foreach ($customerSalesChannels as $customerSalesChannel) {
            if ($customerSalesChannel->user) {
                GetCancelledAllegroOrdersFromApi::dispatch($customerSalesChannel->user);
            }
        }
    }

...
interface WixCatalog
{
    ...
    /**
     * @return array{id: string, name: string|null, sku: string|null, price: float|null, image: string|null}|null
     */
    public function getProduct(string $productId): ?array;

    /**
     * @return array<int, array{id: string, name: string|null, sku: string|null, price: float|null, image: string|null}>
     */

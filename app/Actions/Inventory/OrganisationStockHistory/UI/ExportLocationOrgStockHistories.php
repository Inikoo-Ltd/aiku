...
use App\Exports\Inventory\LocationOrgStockHistoriesExport;
use App\Models\Inventory\Warehouse;
use App\Models\SysAdmin\Organisation;
use Lorisleiva\Actions\ActionRequest;
use Symfony\Component\HttpFoundation\BinaryFileResponse;

class ExportLocationOrgStockHistories extends OrgAction
{
    ...
    {
        $export = new LocationOrgStockHistoriesExport($organisation, $filters);

        return $this->export($export, 'location-stock-histories', $filters['type'] ?? 'xlsx');
    }

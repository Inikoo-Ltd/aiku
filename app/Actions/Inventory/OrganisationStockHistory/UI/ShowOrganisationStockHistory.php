        ...
        return Inertia::render(
            ...
            [
                ...
                OrganisationStockHistoryTabsEnum::ORG_STOCKS->value => $this->tab == OrganisationStockHistoryTabsEnum::ORG_STOCKS->value ?
                    ...
                    : Inertia::optional(fn () => OrgStockHistoryResource::collection(IndexOrgStockHistories::run($organisationStockHistory, OrganisationStockHistoryTabsEnum::ORG_STOCKS->value))),
                ...
                OrganisationStockHistoryTabsEnum::LOCATION_ORG_STOCKS->value => $this->tab == OrganisationStockHistoryTabsEnum::LOCATION_ORG_STOCKS->value ?
                    ...
                    : Inertia::optional(fn () => LocationOrgStockHistoriesResource::collection(IndexLocationOrgStocksForOrganisationStockHistory::run($organisationStockHistory, OrganisationStockHistoryTabsEnum::LOCATION_ORG_STOCKS->value))),
                ...
                OrganisationStockHistoryTabsEnum::OUT_OF_STOCK->value => $this->tab == OrganisationStockHistoryTabsEnum::OUT_OF_STOCK->value ?
                    ...
                    : Inertia::optional(fn () => OrgStockHistoryResource::collection(IndexOrgStockHistories::run($organisationStockHistory, OrganisationStockHistoryTabsEnum::OUT_OF_STOCK->value, 'out_of_stock'))),
                ...
                OrganisationStockHistoryTabsEnum::NOT_SOLD_1Y->value => $this->tab == OrganisationStockHistoryTabsEnum::NOT_SOLD_1Y->value ?
                    ...
                    : Inertia::optional(fn () => OrgStockHistoryResource::collection(IndexOrgStockHistories::run($organisationStockHistory, OrganisationStockHistoryTabsEnum::NOT_SOLD_1Y->value, 'not_sold_1y'))),
                ...
                OrganisationStockHistoryTabsEnum::DORMANT_STOCK_1Y->value => $this->tab == OrganisationStockHistoryTabsEnum::DORMANT_STOCK_1Y->value ?
                    ...
                    : Inertia::optional(fn () => OrgStockHistoryResource::collection(IndexOrgStockHistories::run($organisationStockHistory, OrganisationStockHistoryTabsEnum::DORMANT_STOCK_1Y->value, 'dormant_stock_1y'))),

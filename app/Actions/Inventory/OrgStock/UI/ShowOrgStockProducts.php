...
use App\Enums\UI\Procurement\OrgStockProductsTabsEnum;
...
class ShowOrgStockProducts extends OrgAction
{
    ...
    private string $tabsEnum = OrgStockProductsTabsEnum::class;
    ...
    public function htmlResponse(OrgStock $orgStock, ActionRequest $request): Response
    {
        ...
        return Inertia::render(
            ...
            ->table(IndexProductsInOrgStock::make()->tableStructure(prefix: $this->tabsEnum::PRODUCTS->value));
    }

    public function getBreadcrumbs(OrgStock $orgStock, string $routeName, array $routeParameters): array
    {
        $routeName = preg_replace('/.products$/', '', $routeName);

        return ShowOrgStock::make()->getBreadcrumbs($orgStock, $routeName, $routeParameters, '('.__('Products/Sales').')');
    }

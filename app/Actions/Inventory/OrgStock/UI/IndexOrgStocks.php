        ...
        return function (InertiaTable $table) use ($parent, $modelOperations, $prefix, $bucket, $sales) {
            ...
            if ($sales) {
                ...
                $table
                    ...
                    ->column(key: 'stock_value', label: __('Value'), tooltip: __('Stock value — valued with FIFO (recommended, the official valuation)'), tooltipIcon: true, canBeHidden: false, sortable: true, type: 'currency')

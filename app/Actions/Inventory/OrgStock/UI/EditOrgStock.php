            ...
            [
                ...
                'fields' => [
                    ...
                    'is_excluded_from_auto_ordering' => [
                        ...
                        'value'       => $orgStock->is_excluded_from_auto_ordering,
                        'information' => __('Procurement auto-fill proposals skip this SKO. It can still be added to shopping lists by hand.'),
                    ],

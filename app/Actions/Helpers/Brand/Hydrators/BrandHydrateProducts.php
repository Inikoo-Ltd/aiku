...
class BrandHydrateProducts implements ShouldBeUnique
{
    use AsAction;

    public string $commandSignature = 'hydrate:brands_products {brandSlug?}';
    ...
    {
        $brand->updateQuietly([
            'number_products' => $brand->products()->count(),
        ]);
    }

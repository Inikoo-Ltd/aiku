...
class GetGeneratedProductDescription extends OrgAction
{
    public function handle(string $prompt, array $metadata = []): string
    {
        ...
        $systemPrompt = "You are a product copywriter. Generate ONLY a compelling product description in {$language} with a {$tone} tone. No title, no heading, just the description paragraph.";

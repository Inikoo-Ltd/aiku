...
class ShowTicketsDashboard extends OrgAction
{
    ...
    public function handle(Group $group, User $user): array
    {
        ...
        $open       = fn (): Builder => (clone $base)->whereIn('status', [TicketStatusEnum::OPEN, TicketStatusEnum::ASSIGNED, TicketStatusEnum::IN_PROGRESS, TicketStatusEnum::WAITING, TicketStatusEnum::PENDING_DEPLOY]);
        ...
        if ($canManage) {
            ...
            $data['by_status']   = collect([TicketStatusEnum::OPEN, TicketStatusEnum::ASSIGNED, TicketStatusEnum::IN_PROGRESS, TicketStatusEnum::WAITING, TicketStatusEnum::PENDING_DEPLOY])->map(fn (TicketStatusEnum $status) => [
                'status' => $status->value,

            ...
            return [
                ...
                'overtimes' => $overtimeRequests->get($employee->id, collect())->map(function (OvertimeRequest $request) {
                    ...
                    return [
                        ...
                        'start_time' => $request->requested_start_at ? $request->requested_start_at : '-',
                        'end_time' => $request->requested_end_at ? $request->requested_end_at : '-',
                        'recorded_start_time' => $request->recorded_start_at ? $request->recorded_start_at : '-',
                        'recorded_end_time' => $request->recorded_end_at ? $request->recorded_end_at : '-',

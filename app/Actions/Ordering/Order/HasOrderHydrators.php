...
use App\Actions\CRM\Customer\Hydrators\CustomerHydrateCustomerSalesChannelStats;
...
trait HasOrderHydrators
{
    public function orderHydrators(Order $order): void
    {
        ...
        if ($order->customer_id) {
            ...
            CustomerHydrateCustomerSalesChannelStats::dispatch($order->customer_id)->delay($this->hydratorsDelay);
        }

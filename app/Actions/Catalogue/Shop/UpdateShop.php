        ...
        foreach ($modelData as $key => $value) {
            data_set(
                ...
                match ($key) {
                    ...
                    'faire_is_shipping_by_external'    => 'settings.faire.faire_is_shipping_by_external',
                    'faire_send_orders_automatically_to_warehouse'    => 'settings.faire.faire_send_orders_automatically_to_warehouse',

    ...
    public function getImagesData(Product $product): array
    {
        ...
        return [
            ...
            [
                ...
                'id' => $product->size_comparison_image_id,

...
class IndexDepartmentsNeedReviews extends OrgAction
{
    use WithCatalogueAuthorisation;

    public function handle(Group|Shop|Organisation|Collection|MasterProductCategory $parent, $prefix = null): LengthAwarePaginator
    {
    ...
    public function tableStructure(Group|Shop|ProductCategory|Organisation|Collection|MasterProductCategory $parent, ?array $modelOperations = null, $prefix = null, $canEdit = false): Closure
    {
        return function (InertiaTable $table) use ($parent, $modelOperations, $prefix, $canEdit) {
            ...
            if ($parent instanceof MasterProductCategory) {
                $table
                    ->column(key: 'shop_code', label: 'Shop', canBeHidden: false, sortable: true);
            }

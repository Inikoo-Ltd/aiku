...
class IndexProductCategoryImages extends OrgAction
{
    public function handle(ProductCategory $productCategory, $prefix = null): LengthAwarePaginator
    {
        ...
        $queryBuilder->where('model_has_media.model_id', $productCategory->id);
        $queryBuilder->where('model_has_media.model_type', 'ProductCategory');

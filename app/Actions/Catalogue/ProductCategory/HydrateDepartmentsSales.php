 ...
 * Created: Sat, 14 Feb 2026 15:52:24 Malaysia Time, Kuala Lumpur, Malaysia
...
class HydrateDepartmentsSales
{
    use WithHydrateCommand;

    public string $commandSignature = 'hydrate:departments_sales {organisations?*} {--S|shop= shop slug} {--s|slugs=}';

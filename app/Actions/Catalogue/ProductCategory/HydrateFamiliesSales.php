 ...
 * Created: Sat, 14 Feb 2026 15:53:46 Malaysia Time, Kuala Lumpur, Malaysia
...
class HydrateFamiliesSales
{
    use WithHydrateCommand;

    public string $commandSignature = 'hydrate:families_sales {organisations?*} {--S|shop= shop slug} {--s|slugs=} ';

...
class RedoDepartmentsTimeSeries
{
    ...
    public string $commandSignature = 'departments:redo_type_series {organisations?*} {--S|shop= shop slug} {--s|slug=} {--f|frequency=all : The frequency for time series (all, daily, weekly, monthly, quarterly, yearly)} {--a|async : Run synchronously}';

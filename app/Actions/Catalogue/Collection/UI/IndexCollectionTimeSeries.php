...
use App\Models\Catalogue\CollectionTimeSeriesRecord;
use App\Services\QueryBuilder;
use Closure;
use Illuminate\Pagination\LengthAwarePaginator;

class IndexCollectionTimeSeries extends OrgAction
{
    public function handle(Collection $collection, string|null $prefix): LengthAwarePaginator
    {
        ...
        return QueryBuilder::for(CollectionTimeSeriesRecord::class)
            ->where('collection_time_series_id', $timeSeries->id)
            ->select([
                'id',
                'from',
                'to',

...
class GetReviewCustomers
{
    ...
    public function handle(ProductCategory $productCategory, int $page = 1, int $perPage = 50, ?string $search = null): array
    {
        return ReviewsResource::paginateReviewCustomers($productCategory, $page, $perPage, $search);
    }

...
class ProcessOrganisationTimeSeriesRecords implements ShouldBeUnique
{
    ...
    protected function processTimeSeries(OrganisationTimeSeries $timeSeries, string $from, string $to): void
    {
        ...
        $results = $this->applyFrequencyGrouping($query, $timeSeries->frequency, customSelects: [...$this->organisationInvoiceSelects(), ...$this->partnerInvoiceSelects()])->get();
        ...
        $this->syncTimeSeriesRecords($timeSeries, $rows, ['organisation_time_series_id', 'period', 'frequency'], $from, $to);
    }

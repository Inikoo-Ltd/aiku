...
class OrganisationHydrateOrderStatePacked implements ShouldBeUnique
{
    ...
    public function handle(int $organisationID): void
    {
        ...
        $stats = [
            ...
            'orders_state_packed_amount_org_currency' => $organisation->orders()->where('state', OrderStateEnum::PACKED)->sum('grp_org_amount'),
            ...
            'orders_packed_today_amount_org_currency' => $organisation->orders()->whereDate('packed_at', Carbon::today())->sum('grp_org_amount'),

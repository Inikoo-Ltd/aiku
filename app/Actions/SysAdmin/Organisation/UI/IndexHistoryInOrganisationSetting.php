...
class IndexHistoryInOrganisationSetting extends OrgAction
{
    use AsAction;
    use WithAttributes;
    ...
    public function handle(Organisation $organisation, $prefix = null): LengthAwarePaginator|array|bool
    {
        ...
        $queryBuilder->where('auditable_type', $organisation->getMorphClass())
            ->where('auditable_id', $organisation->id);
    ...
    public function tableStructure($prefix = null, ?array $exportLinks = null): Closure
    {
        return function (InertiaTable $table) use ($exportLinks, $prefix) {
            ...
            $table
                ...
                ->column(key: 'values', label: __('Value'), canBeHidden: false, sortable: false)

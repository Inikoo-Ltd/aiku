 ...
 * Created: Tue, 21 Jul 2026 16:30:14 Malaysia Time, Kuala Lumpur, Malaysia
...
class AddMissingShopFamiliesFromMasterFamily
{
    use asAction;
    ...
    {
        return 'repair:add_missing_shop_families_from_master_family {from}';
    }

...
class RepairMasterCollectionOrderingIntervals
{
    use AsAction;

    public string $commandSignature = 'repair:master-collection-ordering-intervals {masterShops?*} {--s|slugs=}';
    ...
    public function asCommand(Command $command): int
    {
        ...
        $command->info("Repairing Master Collection Ordering Intervals...");

...
class RepairCollectionOrderingIntervals
{
    use AsAction;

    public string $commandSignature = 'repair:collection-ordering-intervals {organisations?*} {--s|slugs=}';

    public function handle(Collection $collection): void
    {
        $collection->orderingIntervals()->updateOrCreate(
    ...
    public function asCommand(Command $command): int
    {
        ...
        $command->info("Repairing Collection Ordering Intervals...");

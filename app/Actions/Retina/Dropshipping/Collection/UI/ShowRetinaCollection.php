        ...
        return Inertia::render(
            ...
            [
                ...
                RetinaCollectionTabsEnum::FAMILIES->value => $this->tab == RetinaCollectionTabsEnum::FAMILIES->value ?
                    ...
                    : Inertia::optional(fn () => FamiliesInCollectionResource::collection(IndexFamiliesInCollection::run($collection, prefix: RetinaCollectionTabsEnum::FAMILIES->value))),
                ...
                RetinaCollectionTabsEnum::PRODUCTS->value => $this->tab == RetinaCollectionTabsEnum::PRODUCTS->value ?
                    ...
                    : Inertia::optional(fn () => ProductsResource::collection(IndexProductsInCollection::run($collection, prefix: RetinaCollectionTabsEnum::PRODUCTS->value))),
                ...
                RetinaCollectionTabsEnum::COLLECTIONS->value => $this->tab == RetinaCollectionTabsEnum::COLLECTIONS->value ?
                    ...
                    : Inertia::optional(fn () => CollectionsResource::collection(IndexCollectionsInCollection::run($collection, prefix: RetinaCollectionTabsEnum::COLLECTIONS->value))),
            ]
        )
            ->table(

        ...
        return Inertia::render(
            ...
            [
                ...
                'ebay_warehouse_policy_msg'                                 => [
                    'show_msg'         => $this->customerSalesChannel->platform->type == PlatformTypeEnum::EBAY && EbayOverseasWarehousePolicy::isAffected($this->customer->deliveryAddress->country_code),

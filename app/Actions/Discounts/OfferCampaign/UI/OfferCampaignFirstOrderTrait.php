...
trait OfferCampaignFirstOrderTrait
{
    public function getFirstOrderHtmlResponse(OfferCampaign $offerCampaign, ActionRequest $request): Response
    {
        return Inertia::render(
            'Org/Discounts/FirstOrderCampaign',
            [

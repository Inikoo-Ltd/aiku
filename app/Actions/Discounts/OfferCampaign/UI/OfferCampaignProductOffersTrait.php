...
trait OfferCampaignProductOffersTrait
{
    public function getProductOffersHtmlResponse(OfferCampaign $offerCampaign, ActionRequest $request): Response
    {
        return Inertia::render(
            'Org/Discounts/ProductOffersCampaign',
            [

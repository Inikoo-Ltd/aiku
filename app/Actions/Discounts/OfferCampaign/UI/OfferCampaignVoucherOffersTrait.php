...
trait OfferCampaignVoucherOffersTrait
{
    public function getVoucherHtmlResponse(OfferCampaign $offerCampaign, ActionRequest $request): Response
    {
        return Inertia::render(
            'Org/Discounts/VoucherOffersCampaign',
            [
        ...
        ->table(IndexOffers::make()->tableStructure(parent: $offerCampaign, prefix: OfferCampaignTabsEnum::OFFERS->value, showActions: $offerCampaign->shop->is_aiku))

...
class GetStaffTasks
{
    ...
    public const array VIEWS = ['mine', 'department', 'requested'];

    public function handle(User $user, string $view = 'mine', bool $closed = false): Collection
    {
    ...
    {
        return StaffTaskResource::collection($this->handle($request->user(), $request->validated('view', 'mine'), (bool) $request->validated('closed', false)));
    }
}

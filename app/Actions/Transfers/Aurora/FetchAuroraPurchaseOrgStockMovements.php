...
class FetchAuroraPurchaseOrgStockMovements extends FetchAuroraAction
{
    public string $commandSignature = 'fetch:purchase_stock_movements {organisations?*} {--s|source_id=} {--d|db_suffix=} {--N|only_new : Fetch only new} {--D|days= : fetch last n days} {--O|order= : order asc|desc}';
    ...
    public function getModelsQuery(): Builder
    {
        $query = DB::connection('aurora')
            ...
            ->where('Inventory Transaction Type', 'In')
            ->where('Inventory Transaction Section', 'In');
        if ($this->onlyNew) {

...
class CallApiDpdGbShipping extends OrgAction
{
    ...
    public function getServices(Shipper $shipper, array $parcels, array $parentResource): array
    {
        ...
        $data = [
            ...
            'deliveryDetails.address.countryCode' => Arr::get($parentResource, 'from_address.country_code', 'Unknown'),
            ...
            'collectionDetails.address.countryCode' => Arr::get($parentResource, 'to_address.country_code', 'Unknown'),

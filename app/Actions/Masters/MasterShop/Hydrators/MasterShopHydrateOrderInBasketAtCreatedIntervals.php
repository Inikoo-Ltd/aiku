 ...
 * Created: Sun, 24 Aug 2025 17:51:33 Central Standard Time, Mexico City, Mexico
...
class MasterShopHydrateOrderInBasketAtCreatedIntervals implements ShouldBeUnique
{
    use AsAction;
    ...
    public function handle(int $masterShopID, ?array $intervals = null, ?array $doPreviousPeriods = null): void
    {
        ...
        $masterShop->orderingIntervals()->update(
            $this->getBasketCountStats('created_at', $masterShop, $intervals, $doPreviousPeriods),
        );

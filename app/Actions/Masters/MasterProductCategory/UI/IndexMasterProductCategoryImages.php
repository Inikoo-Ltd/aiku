...
class IndexMasterProductCategoryImages extends OrgAction
{
    public function handle(MasterProductCategory $masterProductCategory, $prefix = null): LengthAwarePaginator
    {
        ...
        $queryBuilder->where('model_has_media.model_id', $masterProductCategory->id);
        $queryBuilder->where('model_has_media.model_type', 'MasterProductCategory');
        ...
        $queryBuilder
            ...
            ->selectRaw('? as model_name', [$masterProductCategory->name]);

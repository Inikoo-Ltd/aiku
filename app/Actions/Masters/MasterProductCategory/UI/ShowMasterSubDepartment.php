...
class ShowMasterSubDepartment extends OrgAction
{
    ...
    public function htmlResponse(MasterProductCategory $masterSubDepartment, ActionRequest $request): Response
    {
        ...
        return Inertia::render(
            ...
            [
                'title'            => __('Master sub-department').': '.$masterSubDepartment->code,
                ...
                MasterSubDepartmentTabsEnum::SALES_ANALYSIS->value => $this->tab === MasterSubDepartmentTabsEnum::SALES_ANALYSIS->value ?
                    Inertia::defer(fn () => GetSalesAnalysis::run(SalesAnalysisScope::forMasterCategory($masterSubDepartment), $request->only(['from', 'to', 'compareFrom', 'compareTo', 'organisations', 'shops', 'partners'])), 'sales_analysis')
    ...
    public function jsonResponse(MasterProductCategory $masterSubDepartment): MasterSubDepartmentsResource
    {
        return new MasterSubDepartmentsResource($masterSubDepartment);
    }

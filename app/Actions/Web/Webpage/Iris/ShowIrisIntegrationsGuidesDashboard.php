...
class ShowIrisIntegrationsGuidesDashboard
{
    use AsAction;
    use WithIrisBlogBreadcrumbs;

    private const SUB_TYPES = [WebpageSubTypeEnum::INTEGRATIONS_GUIDES];
    ...
    public function htmlResponse(LengthAwarePaginator $blogs, ActionRequest $request): Response
    {
        ...
        return Inertia::render(
            'BlogDashboard',
            [
                'breadcrumbs'   => $this->getIrisBlogDashboardBreadcrumbs(WebpageSubTypeEnum::INTEGRATIONS_GUIDES),
                'title'         => __('Integrations Guides'),
                'blog_category' => WebpageSubTypeEnum::INTEGRATIONS_GUIDES->value,

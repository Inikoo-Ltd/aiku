...
class ShowIrisDropshippingGuidesDashboard
{
    use AsAction;
    use WithIrisBlogBreadcrumbs;

    private const SUB_TYPES = [WebpageSubTypeEnum::DROPSHIPPING_GUIDES];
    ...
    public function htmlResponse(LengthAwarePaginator $blogs, ActionRequest $request): Response
    {
        ...
        return Inertia::render(
            'BlogDashboard',
            [
                'breadcrumbs'   => $this->getIrisBlogDashboardBreadcrumbs(WebpageSubTypeEnum::DROPSHIPPING_GUIDES),
                'title'         => __('Dropshipping Guides'),
                'blog_category' => WebpageSubTypeEnum::DROPSHIPPING_GUIDES->value,

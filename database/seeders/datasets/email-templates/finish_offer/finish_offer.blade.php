  ...
  <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
    ...
    <td class="container" width="600"
      ...
      <div class="content" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; max-width: 600px; display: block; margin: 0 auto; padding: 20px;">
        <table class="main" width="100%" cellpadding="0" cellspacing="0"
          ...
          <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
            <td class="alert alert-success"
              ...
              <span class="fallback-text"><span style="font-weight:800">Offer Finished</span> [Offer Code] - [Shop Name]</span>
            </td>
          </tr>
          <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                  <td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                      valign="top">
                      <span class="fallback-text">An offer has been finished with the following details:</span>
                  </td>
                </tr>
                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                  <td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                      valign="top">
                    <strong>Offer Code:</strong> <a href="[Offer Link]" target="_blank" style="color: #3498DB; text-decoration: underline;">[Offer Code]</a><br/>
                    <strong>Offer Name:</strong> [Offer Name]<br/>
                    <strong>Campaign:</strong> <a href="[Campaign Link]" target="_blank" style="color: #3498DB; text-decoration: underline;">[Campaign Name]</a><br/>
                    <strong>Created Date:</strong> [Created Date]<br/>
        ...
        <table class="offer-details" width="100%" cellpadding="0" cellspacing="0"
                  ...
                  <td class="content-wrap" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 20px;" valign="top">
                      ...
                      <table width="100%" cellpadding="8" cellspacing="0" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; border-collapse: collapse;">
                          ...
                          <tr style="border-bottom: 1px solid #e9e9e9;">
                              <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 14px; padding: 8px 0; text-align: left; font-weight: bold; width: 50%;">Field</td>
                              <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 14px; padding: 8px 0; text-align: right; font-weight: bold; width: 50%;">Value</td>
                          </tr>

                          <!-- Offer Type -->
                          <tr style="border-bottom: 1px solid #f0f0f0;">
                              <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 14px; padding: 8px 0; text-align: left;">Type</td>
                              <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 14px; padding: 8px 0; text-align: right;">[Offer Type]</td>
                          </tr>

                          <!-- Duration -->
                          <tr style="border-bottom: 1px solid #f0f0f0;">
                              <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 14px; padding: 8px 0; text-align: left;">Duration</td>
                              <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 14px; padding: 8px 0; text-align: right;">[Duration]</td>
                          </tr>

                          <!-- Start Date -->
                          <tr style="border-bottom: 1px solid #f0f0f0;">
                              <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 14px; padding: 8px 0; text-align: left;">Start Date</td>
                              <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 14px; padding: 8px 0; text-align: right;">[Start Date]</td>
                          </tr>

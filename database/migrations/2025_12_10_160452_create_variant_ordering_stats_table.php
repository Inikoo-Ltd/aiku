 ...
 * Created: Thu, 11 Dec 2025 00:36:40 Malaysia Time, Kuala Lumpur, Malaysia
...
return new class () extends Migration {
    ...
    {
        Schema::create('variant_sales_ordering_stats', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('variant_sales_ordering_stats');
    }
};

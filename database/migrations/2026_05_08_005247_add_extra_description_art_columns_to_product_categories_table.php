...
return new class () extends Migration {
    public function up(): void
    {
        Schema::table('product_categories', function (Blueprint $table): void {
            if (!Schema::hasColumn('product_categories', 'extra_desc_art2')) {
                $table->unsignedInteger('extra_desc_art2')->nullable();
            }

            if (!Schema::hasColumn('product_categories', 'extra_desc_art3')) {
                $table->unsignedInteger('extra_desc_art3')->nullable();
            }

            if (!Schema::hasColumn('product_categories', 'extra_desc_art4')) {

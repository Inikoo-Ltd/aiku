...
return new class () extends Migration {
    ...
    public function up()
    {
        ...
        $columns = [
            'number_outboxes_type_' . OutboxCodeEnum::GOLD_REWARD_REMINDER_1->snake(),
            'number_outboxes_type_' . OutboxCodeEnum::GOLD_REWARD_REMINDER_2->snake(),
            'number_outboxes_type_' . OutboxCodeEnum::GOLD_REWARD_REMINDER_3->snake(),
        ];

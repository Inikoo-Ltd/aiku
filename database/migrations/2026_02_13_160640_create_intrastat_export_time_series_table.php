 ...
 * Created: Thu, 13 Feb 2026 16:06:40 Central Indonesia Time, Sanur, Bali, Indonesia
...
return new class () extends Migration {
    ...
    {
        Schema::create('intrastat_export_time_series', function (Blueprint $table) {
            $table->increments('id');
            $table->unsignedSmallInteger('organisation_id');
            $table->foreign('organisation_id')->references('id')->on('organisations')->onUpdate('cascade')->onDelete('cascade');
            $table->string('tariff_code')->index()->comment('Tariff code (HS code)');
    ...
    {
        Schema::dropIfExists('intrastat_export_time_series');
    }
};

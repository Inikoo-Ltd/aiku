...
return new class () extends Migration {
    ...
    public function up()
    {
        ...
        $columns = [
            'number_outboxes_type_'.OutboxCodeEnum::CREDIT_BALANCE_NOTIFICATION_FOR_CUSTOMER->snake(),
            'number_outboxes_type_'.OutboxCodeEnum::CREDIT_BALANCE_NOTIFICATION_FOR_USER->snake(),
        ];

...
<template>
    ...
    <div v-if="($page.props as any).tickets_read_only" class="mx-4 mt-4 rounded-md bg-amber-50 border border-amber-300 text-amber-800 px-4 py-2 text-sm">{{ trans("Mirror of Jira, read-only until the cut-over. Raise or update tickets in Jira for now.") }}</div>

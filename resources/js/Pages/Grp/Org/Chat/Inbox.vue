...
import { faEllipsisVertical, faBan, faRotateLeft, faTrash, faTrashArrowUp, faAnglesUp, faAngleUp, faEquals, faChevronRight } from "@fortawesome/free-solid-svg-icons"
...
const selectChannel = (shopId: number, channelKey: string) => {
    if (selectedShopId.value === shopId && selectedChannel.value === channelKey && !spamView.value && !trashView.value) return

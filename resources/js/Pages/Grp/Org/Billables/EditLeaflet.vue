...
const form = useForm<{
    ...
    name: props.leaflet.name,
    type: props.leaflet.type,
    price: props.leaflet.price,
    family_codes: props.leaflet.family_codes ?? [],
    state: props.leaflet.state,
})

const submit = () => {
    form.patch(route(props.updateRoute.name, props.updateRoute.parameters))
}
</script>

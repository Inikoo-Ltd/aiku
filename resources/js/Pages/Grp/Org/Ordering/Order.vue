...
<template>
    ...
    <PageHeading :data="pageHead">
        <template #afterTitle2>
            ...
            <FontAwesomeIcon v-if="data?.data.has_extra_packing" v-tooltip="trans('Extra packing')" icon="fas fa-box-heart" class="text-yellow-500" fixed-width aria-hidden="true" />
        </template>

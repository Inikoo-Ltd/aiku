...
import TableMasterOrphanProducts from "@/Components/Tables/Grp/Goods/TableMasterOrphanProducts.vue";
...
<template>
  ...
  <!-- Products Table -->
  <TableMasterOrphanProducts :data="data" :editable_table :key="key"

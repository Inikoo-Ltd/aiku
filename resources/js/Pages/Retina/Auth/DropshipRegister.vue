		...
		<div class="bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden">
			...
			<form @submit.prevent="submitRegister" class="space-y-12 px-14 py-10">
				...
				<div class="flex justify-end">
					<button
						type="submit"
						class="inline-flex items-center px-6 bg-black py-3 border border-transparent text-sm font-medium rounded-md shadow-xs text-white focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">

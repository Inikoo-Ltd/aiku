...
<template>
    ...
    <div class="rounded-md flex items-center justify-center w-full px-6 py-12 lg:px-8">
        <div class="relative w-full max-w-lg bg-transparent px-4 py-3">
            ...
            <div v-if="layout.retina.type !== 'b2b'" class="border border-gray-300 p-5 rounded-sm mb-4 ">
            ...
            <form class="space-y-6">
                ...
                <div class="w-full">
                    <button
                        ...
                        class="w-full relative flex items-center justify-center gap-2 bg-[#1D252E] disabled:bg-[#393e49] text-white disabled:text-gray-300 hover:bg-black font-normal border border-[#1D252E] rounded-xs px-16 py-2 cursor-pointer transition duration-75 ease-in-out"
                        :disabled="isLoading"
                    >
                        {{ trans("Sign in") }}
                ...
                <div class="w-full">
                    ...
                    >
                        <template #default>
                            <div class="w-full relative flex items-center justify-center gap-2 bg-white hover:bg-[#1D252E] font-normal text-gray-800 hover:text-white border border-[#1D252E] rounded-xs px-16 py-2 cursor-pointer transition duration-150 ease-in-out">

                ...
                <div v-if="props.paymentMethods?.length > 1" class="max-w-lg">
                    <div class="grid grid-cols-1 sm:hidden">
                        ...
                        <select aria-label="Select a tab"
                                class="col-start-1 row-start-1 w-full appearance-none rounded-md bg-white py-2 pl-3 pr-8 text-base  outline -outline-offset-1 outline-gray-300 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600">

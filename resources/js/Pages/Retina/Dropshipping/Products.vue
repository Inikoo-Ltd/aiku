...
<template>
    ...
    <div class="p-8">
        ...
        <div class="bg-stone-100 overflow-hidden rounded-2xl border border-stone-300">
            ...
            <!-- View: Grid -->
            <DataView v-else :value="products" paginator :rows="12" :sortOrder :sortField>
                <template #header>
                        ...
                        >
                            ...
                            <div class="relative flex justify-center rounded-sm">
                                ...
                                <div class="absolute top-1.5 right-2">
                                    <input :checked="isSelected(item.id)" name="checkboxProduct" type="checkbox" class="cursor-pointer h-5 w-5  rounded-sm border-stone-300 text-stone-800 shadow-xs focus:ring-0 focus:outline-hidden">
                                </div>
                            </div>

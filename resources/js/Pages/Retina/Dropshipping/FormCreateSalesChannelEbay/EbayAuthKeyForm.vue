...
<template>
    ...
    <form @submit.prevent="submitForm" class="flex flex-col gap-6">
        <div class="flex items-center gap-2 w-64">
            ...
            <FontAwesomeIcon v-tooltip="trans('Requests a token from eBay so we can sync without you entering your account details each time')" icon="fal fa-info-circle" class="size-5 text-black" />
        </div>

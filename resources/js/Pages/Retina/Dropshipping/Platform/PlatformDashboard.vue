                ...
                <div class="w-full border-2 border-yellow-500 rounded-lg p-4 bg-yellow-50">
                    <div class="flex flex-col sm:flex-row sm:items-start">
                        <div class="flex items-center mb-2 sm:mb-0 sm:flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-500 mr-2 sm:mr-0 sm:mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="sm:ml-3">
                            <p class="text-sm text-yellow-700">
                                <strong class="hidden sm:inline">Important Notice:</strong> To prevent any issues or misunderstandings with the eBay platform, please ensure your eBay account is registered as a seller account. For more information, visit: 

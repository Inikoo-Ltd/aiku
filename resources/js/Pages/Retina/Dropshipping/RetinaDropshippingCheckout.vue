...
<template>
    ...
    <div v-else class="w-full px-4 mt-8">
        ...
        <div v-else-if="to_pay_data.by_other > 0" class="mt-10 md:mx-10 ">
            <div v-if="to_pay_data.by_balance > 0" class="mx-auto text-center text-lg border border-gray-300 py-4 rounded-sm">
                <div>
            ...
            <div class="mt-5 border border-gray-300">
                <div v-if="props.paymentMethods?.length > 1" class="max-w-lg">
                    <div class="grid grid-cols-1 sm:hidden">
                        ...
                        <select aria-label="Select a tab" class="col-start-1 row-start-1 w-full appearance-none rounded-md bg-white py-2 pl-3 pr-8 text-base  outline -outline-offset-1 outline-gray-300 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600">
        ...
        <div v-else-if="(to_pay_data.by_balance > 0) && (to_pay_data.by_balance >= to_pay_data.total)" class="ml-10 mr-4 py-5 flex items-center flex-col gap-y-2 border border-gray-300 rounded-sm">
            <div class="w-64">
                <ButtonWithLink

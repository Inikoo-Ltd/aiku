...
import { faTag, faRobot, faChartLine, faCopy, faCheck, faTimes, faArrowUpRightFromSquare } from '@fal'
                    ...
                    <div class="grid grid-cols-3 gap-2 items-start">
                        ...
                        <div class="col-span-2 text-xs font-medium text-gray-800">
                            <a v-if="!session.is_guest && customerProfile.profile_url"
                                ...
                                <FontAwesomeIcon :icon="['fal', 'fa-arrow-up-right-from-square']" class="text-[10px]" />
                            </a>

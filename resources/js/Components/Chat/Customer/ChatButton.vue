...
<template>
    <div>
        <button ref="buttonRef" @click="toggle"
            class="fixed bottom-36 right-5 z-[60] flex items-center gap-2 px-4 py-4 rounded-xl shadow-lg buttonPrimary"  :class="[
        'fixed bottom-36 z-[60] flex items-center gap-2 px-4 py-4 rounded-xl shadow-lg buttonPrimary transition-all duration-300',
        bundle.open.value ? 'right-[430px]' : 'right-5'
    ]">

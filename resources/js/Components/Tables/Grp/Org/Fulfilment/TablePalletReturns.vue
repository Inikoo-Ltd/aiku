        ...
        <template #buttonreturns="{ linkButton: linkButton }">
            <Link
                ...
                <Button
                    ...
                    class="h-full inline-flex items-center rounded-none text-sm border-none font-medium shadow-xs focus:ring-transparent focus:ring-offset-transparent focus:ring-0">
                </Button>
            </Link>
        </template>
    </Table>

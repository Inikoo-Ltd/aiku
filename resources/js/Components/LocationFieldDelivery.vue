                ...
                <div class="w-[250px]">
                    ...
                    <div>
                       ...
                       <!--  <div class="flex gap-x-1 items-center mt-2 pl-0.5">
                            <input v-model="isPalletDamaged" type="checkbox" id="checkboxLocation" class="rounded-sm border-gray-300 text-red-500 shadow-xs focus:border-indigo-300 focus:ring focus:ring-indigo-200/50">

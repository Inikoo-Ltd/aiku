...
<template>
    ...
    >
        ...
        <div @click="_breadcrumbPopover?.toggle" class="z-50 md:hidden absolute w-64 h-full bg-red-500" aria-label="Transparency clickable area for breadcrumb popup"></div>

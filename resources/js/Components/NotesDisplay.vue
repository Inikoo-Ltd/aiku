    ...
    <div class="flex gap-2 items-center">
        ...
        <template v-for="noteType in getAvailableNoteTypes" :key="noteType.type">
            <button @click="openNotesModal(noteType.type)" v-tooltip="`View ${noteType.title}`"
                class="hover:opacity-80 transition-all duration-200 hover:scale-110 focus:outline-hidden focus:ring-2 focus:ring-offset-1 focus:ring-blue-500 rounded-sm">

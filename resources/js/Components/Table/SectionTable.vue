			...
			<div
				...
				<IconField class="w-full">
					...
					<InputText
						...
						type="text"
						placeholder="Search ..."
						class="border border-gray-300 rounded-sm appearance-none block w-full px-3 py-2 text-sm leading-none transition-all duration-300 placeholder:text-gray-400 placeholder:italic focus:border-gray-500 focus:ring-0 focus:outline-none" />
				</IconField>
			</div>
		</div>

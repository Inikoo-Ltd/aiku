...
<template>
        ...
        <Transition>
            <PopoverPanel class="z-20 absolute right-0 mt-2 min-w-80 origin-top-right rounded-lg overflow-hidden bg-white shadow-lg ring-1 ring-black/5 focus:outline-hidden">
                ...
                >
                    ...
                    <div class="max-w-96 grid grid-cols-2 rounded-sm overflow-hidden w-full flex-wrap justify-end gap-0.5 ">
    ...
    <div v-if="!!selectedGroup" class="hidden md:flex items-center text-xs justify-end w-full">
        <div class=" w-fit flex gap-x-1 lg:gap-x-0  border border-gray-200 rounded-sm">
            <!-- List of element (checkbox) -->
            <div class="w-fit rounded-sm overflow-hidden flex flex-wrap justify-end gap-0.5 ">
            ...
            <Menu as="div" class="relative inline-block text-left" v-slot="{ open }">
                ...
                <transition v-if="Object.keys(props.elements).length > 1" enter-active-class="transition duration-100 ease-out"
                    ...
                    <MenuItems
                        class="absolute right-0 mt-2 w-40 min-w-min origin-top-right divide-y overflow-hidden divide-gray-100 rounded-sm bg-white shadow-lg ring-1 ring-black/5 focus:outline-hidden z-50">
                        <div class="">

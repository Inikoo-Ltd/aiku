    ...
    <div class="px-4 py-4 space-y-3">
        ...
        <div v-if="data.capture" class="border border-gray-200 rounded-md px-4 py-3">
            ...
            <div class="mt-1 pl-4 text-xs text-gray-500">
                {{ trans('Counted across all shops. No hits at all means the storefront is not reporting visits and nothing can be attributed.') }}
            </div>
            ...
            <table class="mt-2 ml-4 text-xs text-gray-600">
                <thead>
                    <tr class="text-gray-400">
                        ...
                        <th class="text-right font-normal px-2">{{ trans('Hits') }}</th>
                ...
                <tbody>
                    <tr v-for="row in data.capture.rows" :key="row.visitor">
                        ...
                        <td class="text-right px-2 tabular-nums">{{ row.hits }}</td>

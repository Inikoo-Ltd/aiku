                                        ...
                                        <div class="pl-2 flex items-center gap-x-4">
                                            <template v-for="subDepartment, idxSubDepartment in jobGroup.subDepartment">
                                                ...
                                                <div
                                                    ...
                                                    class="group h-full  flex items-center justify-start rounded-md py-3 px-3 font-medium disabled:text-gray-400 disabled:xxcursor-not-allowed disabled:ring-0 disabled:active:active:ring-offset-0"

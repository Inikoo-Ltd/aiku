    ...
    <div class="h-9 flex  items-center justify-between mb-3">
        ...
        <div v-if="blueprint.checkbox" class="flex items-center gap-x-3">
            ...
            <Switch
                ...
                class="pr-1 relative inline-flex h-5 aspect-[2/1] shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors bg-white ring-1 ring-slate-300 duration-200 shadow-sm ease-in-out focus:outline-hidden focus-visible:ring-2 focus-visible:ring-white/75"
            >

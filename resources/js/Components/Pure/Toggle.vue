...
// TODO: make toggle smaller h-6 w-12 to h-5 w-10
</script>
...
<template>
    ...
    >
        <span aria-hidden="true" :class="modelValue ? 'translate-x-6 bg-white ' : 'translate-x-0 bg-gray-50'"
            ...
            <FontAwesomeIcon v-else-if="modelValue" icon='far fa-check' class='text-sm text-green-600' fixed-width aria-hidden='true' />

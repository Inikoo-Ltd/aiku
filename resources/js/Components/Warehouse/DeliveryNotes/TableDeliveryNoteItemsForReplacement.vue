...
const getInputClasses = computed(() => {
    return (item: any) => {
        const baseClasses = "w-full px-3 py-2 text-sm border rounded-l-md focus:outline-hidden focus:ring-2";
        const invalidClasses = "bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500/50 focus:border-red-500";
        const validClasses = "bg-white border-gray-300 text-gray-900 focus:ring-blue-500/50 focus:border-blue-500";

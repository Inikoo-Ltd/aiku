		...
		<div class="grid gap-4 lg:grid-cols-2 lg:items-start">
			<div class="flex flex-col gap-4">
				...
				<div class="space-y-2 rounded-2xl border border-gray-200 bg-white p-4">
					...
					<div
						v-if="modelValue?.review_images?.length"
						class="grid gap-3 pt-2 sm:grid-cols-3">
						<div
							v-for="(item, index) in modelValue?.review_images"
			...
			<div class="flex flex-col gap-1">
				<div
					...
					<div>
						...
						<p class="mt-0.5 text-sm text-gray-500">
							{{ trans("Share your experience with this product") }}
						</p>
					</div>
				...
				<div
					v-if="activeRatings.length"
					class="space-y-1 rounded-2xl bg-white ">
					<div

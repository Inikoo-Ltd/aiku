		...
		<TransitionRoot as="template" :show="isOpenModal">
			<Dialog class="relative z-30" @close="isOpenModal = false">
				...
				<div class="fixed inset-0 z-10 w-screen overflow-y-auto">
					<div
						class="flex min-h-full xitems-end justify-center p-4 text-center items-center sm:p-0">
						<TransitionChild
							as="template"
							enter="ease-out duration-150"
									...
									<div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
										...
										<div class="mt-5 flex flex-row-reverse gap-2">
											...
											<Button
												...
												" />
											<!-- <button type="button"
                                                class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold ring-1 ring-gray-300 ring-inset hover:bg-gray-50 sm:mt-0 sm:w-auto"
                                                >{{ trans("Cancel") }}</button> -->
										</div>
									</div>
								</div>

<!--
  ...
  - Created: Thu, 06 Nov 2025 12:06:24 Western Indonesia Time, Lembeng Beach, Bali, Indonesia
...
<template>
    ...
    <Dialog v-model:visible="isModalTag" modal header="Create new tag" :style="{ width: '600px' }">
        <div class="isolate bg-white px-6 lg:px-8">
            ...
            <div class="mt-6 mb-4 relative">
                <Button @click="() => onCreateNewTag()" label="Submit" :disabled="!newTagName" :loading="isLoadingCreateTag" full />
            </div>
        </div>
    </Dialog>
    ...
    <Dialog v-model:visible="isModalUpdateTag" modal header="Edit tag" :style="{ width: '600px' }">
        <div class="isolate bg-white px-6 lg:px-8">
            ...
            <div class="mt-6 mb-4 relative">
                <Button @click="() => onEditTag()" label="Update tag" :disabled="!selectedUpdateTag?.name" :loading="isLoadingUpdateTag" full />
            </div>
        </div>
    </Dialog>
</template>

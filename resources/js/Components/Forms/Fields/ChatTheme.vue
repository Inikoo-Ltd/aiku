    ...
    <div class="relative w-full">
        <div class="flex flex-wrap gap-x-2 gap-y-3">
            <div
                ...
                class="relative h-20 aspect-[16/9] w-fit flex flex-col justify-center gap-1 px-2 ring-1 ring-gray-300 hover:ring-2 hover:ring-gray-500 shadow rounded overflow-hidden cursor-pointer"

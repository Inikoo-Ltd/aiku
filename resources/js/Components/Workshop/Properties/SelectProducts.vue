...
const fetchRecommenders = async (recommendation_type: string) => {
    ...
    //         `https://live.luigisbox.tech/v1/recommend?tracker_id=${webpage_luigi_tracker_id}`,
    //         [
    //             {
...
<template>
  <div class="space-y-6">
    ...
    <div>
        ...
        <!-- <select
            v-model="localType"
            class="border border-gray-300 px-4 py-2 rounded-sm w-full focus:ring-2 focus:ring-primary focus:outline-hidden"
        >

...
<template>
	<div class="relative w-fit" :class="parentClass">
		<div
			v-if="true"
			class="flex items-center justify-center border border-gray-300 rounded-sm gap-y-1 px-1 py-0.5">
			...
			<div
				...
				<div
					...
					class="leading-4 inline-flex items-center gap-x-2 font-medium focus:outline-hidden disabled:cursor-not-allowed min-w-max bg-transparent border border-gray-300 rounded-sm px-2.5 lg:px-1 py-2.5 lg:py-1.5 text-xs justify-self-center"
					:class="[

...
import { getComponent } from "@/Composables/getWorkshopComponents.ts"
  ...
  <div class="h-[85vh] grid grid-cols-12 gap-4 p-3">
    <div class="col-span-3 bg-white rounded-xl shadow-md p-4 overflow-y-auto border">
      <SideMenuFamilyWorkshop :data="data.layout" :webBlockTypes="data.web_block_types" :dataList="data.families"
        @auto-save="autosave" @set-up-template="onPickTemplate" @onChangeDepartment="onChangeDepartment" />
    </div>
    ...
    <div class="col-span-9 bg-white rounded-xl shadow-md flex flex-col overflow-auto border">
      ...
      <div v-if="props.data.layout?.code" class="editor-class">
          ...
          <component 
            ...
            :modelValue="{
              ...data.layout.data.fieldValue,
                ...
                model_type : 'family',
                model_id : data.family.id,
                model_slug : data.family.slug
              }" 
          />
        </div>
      </div>

...
<template>
	...
	<div
		...
		<!-- 	<span class="">
			...
			<!-- <span class="">
				<a
					...
					<span
						v-html="
							textReplaceVariables(model?.register?.text, layout.iris_variables)
						" />
				</a>
			</span> -->
              <ButtonWithLink
		...
		<div
			...
			v-html="textReplaceVariables(model?.main_title?.text, layout.iris_variables)"></div>

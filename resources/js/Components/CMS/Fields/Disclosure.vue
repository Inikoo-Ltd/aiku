...
import DisclosureProperty from "@/Components/Workshop/Properties/DisclosureProperty.vue";
...
const addDisclosure = () => {
    ...
    newValue.push({
        ...
        description: "New Disclosure description",
    });
...
<template>
    <div>
            ...
            <template #item="{ element: field, index }">
                <div class="py-1">
                    <Disclosure v-slot="{ open }">
                        <DisclosureButton
                            class="flex w-full items-center justify-between bg-gray-100 px-4 py-2 text-left text-sm font-medium text-gray-900 hover:bg-gray-200 focus:outline-hidden focus-visible:ring-3 focus-visible:ring-gray-500/75">
        ...
        <div class="my-2">
            <Button type="dashed" label="Add Disclosure" :icon="faPlus" full @click="addDisclosure"></Button>
        </div>
    </div>
</template>

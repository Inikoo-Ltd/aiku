		...
		<div class="mt-4 grid grid-cols-3 gap-x-4">
			...
			<div class="col-span-2 self-end w-full justify-end flex gap-x-2">
				<div
					...
					class="leading-4 cursor-pointer inline-flex items-center gap-x-2 font-medium focus:outline-hidden disabled:cursor-not-allowed min-w-max bg-transparent border border-gray-300 text-gray-700 hover:bg-gray-200/70 disabled:bg-gray-200/70 rounded-sm px-1 py-1.5 text-base justify-self-center"
				>

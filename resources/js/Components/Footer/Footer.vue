...
<template>
    <footer class="z-20 fixed w-screen md:max-w-[calc(100%_-_var(--chat-pane,0px))] bottom-0 left-0 text-white bg-black transition-all duration-300 ease-in-out" :class="layout?.messagingSidebar?.show ? 'md:pr-56' : (layout?.messagingSidebar?.micro ? 'md:pr-4' : 'md:pr-12')">

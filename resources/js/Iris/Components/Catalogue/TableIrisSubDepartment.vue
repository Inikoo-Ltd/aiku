...
<template>
    <div v-if="parentInfo" class="flex flex-wrap items-center gap-x-2 gap-y-1 px-3 py-2 bg-amber-50 border border-amber-200 rounded-lg mb-2">
        ...
        <template #card="{ item }">
            <div
                ...
                <div class="min-w-0 flex-1">
                    <Link :href="`/catalogue/sub-department/${item.slug}`" class="primaryLink  truncate text-sm">
                        {{ item.code }}
                    </Link>

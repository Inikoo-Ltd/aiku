...
<template>
    ...
    <div  :id="fieldValue?.id ? fieldValue?.id  : 'list-products-ecom-iris'"  component="list-products-ecom-iris" class="">
        ...
        <div class="flex flex-col lg:flex-row" :style="{
            ...
            <div class="flex-1" >
                <!-- Search & Sort -->
                <div class="px-4 pt-3 pb-2 flex flex-col md:flex-row justify-between items-center gap-4" :style="{...getStyles(fieldValue?.container?.properties, screenType), paddingTop : '0px', paddingBottom : '0px'}">

...
<template>
    <div v-if="isMobile" class="w-full px-4 py-2 h-16 flex items-center justify-center"
    ...
    <div v-else class="w-full flex items-center justify-between px-4 py-2"
        :style="getStyles(announcementData?.container_properties)">
        ...
        <div class="flex items-center gap-4 text-purple-800 font-semibold text-xs
            ...
            <div v-if="announcementData?.fields?.text_2?.text"
                class="text-center md:text-left min-w-0"
        ...
        <div class="flex items-center gap-4 text-purple-900 text-sm
            ...
            <div class="flex items-center gap-1 min-w-0">
                <div v-if="announcementData?.fields?.text_1?.text"
                    class="text-center md:text-left min-w-0 truncate"
        ...
        <div class="flex items-center gap-4 text-purple-900 text-sm
            ...
            <div class="-my-4 min-w-0 overflow-hidden">

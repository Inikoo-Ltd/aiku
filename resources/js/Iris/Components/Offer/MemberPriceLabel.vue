...
<template>
    <div class="inline-flex items-center overflow-hidden rounded gap-1" :class="{
       ...
       <!--  <img :src="active
        ...
        :class="[ active ? 'bg-[#E87928] hover:bg-[#ff9b4a]' : 'bg-[#b3b3b3] border border-transparent hover:border-[#E87928] hover:text-[#E87928] hover:bg-white' ]" @mouseenter="showInfo" @mouseleave="hideInfo" @focus="showInfo" @blur="hideInfo" tabindex="0" aria-haspopup="true">

...
import { faCube, faFolder, faFolderTree, faFolderDownload, faTachometerAltFast } from '@fal'
...
library.add(faCube, faFolder, faFolderTree, faFolderDownload, faTachometerAltFast)

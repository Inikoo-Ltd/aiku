...
import TableIrisSubDepartment from '@/Iris/Components/Tables/TableIrisSubDepartment.vue'
...
library.add(faCube, faFolder, faFolderTree, faDotCircle, faAlbumCollection, faTachometerAltFast)

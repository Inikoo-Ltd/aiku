    ...
    <Modal :isOpen="isModalOpen" @onClose="() => isModalOpen = false">
        <div v-if="sectionAuth === 'login'" class="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px] bg-white px-6 py-12 border border-gray-100 shadow-sm sm:rounded-lg sm:px-12">
                <form class="space-y-6" action="#" method="POST">
                    ...
                    <div>
                        <button type="submit"
                            class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign
                            in</button>
                    </div>
                </form>
        ...
        <div v-if="sectionAuth === 'register'" class="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
            ...
            <form class="space-y-6 mt-10 sm:mx-auto sm:w-full sm:max-w-[480px] bg-white px-6 py-12 border border-gray-100 shadow-sm sm:rounded-lg sm:px-12">
                <div>
                    ...
                    <div class="mt-1">
                        <input ref="inputContactName" id="contact_name" name="contact_name" :autofocus="true"
                            ...
                            class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-xs placeholder-gray-400 focus:outline-hidden focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                    </div>
                </div>
                ...
                <div>
                            <button type="submit"
                                class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                Register
                            </button>
                        </div>
                <!-- <div class="flex items-center justify-between">

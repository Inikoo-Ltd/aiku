...
import PupilTopBarSubsections from "@/Layouts/Pupil/PupilTopBarSubsections.vue";
...
<template>
    ...
    <!-- If this Navigation is active, then teleport the SubSections to #PupilTopBarSubsections in <AppTopBar> -->
    <template v-if="isTopMenuActive && isNavigationActive(layout.currentRoute, props.nav.root || 'xx.xx.xx.xx')">
        <Teleport to="#PupilTopBarSubsections" :disabled="!isNavigationActive(layout.currentRoute, props.nav.root || 'xx.xx.xx.xx')">
            <PupilTopBarSubsections

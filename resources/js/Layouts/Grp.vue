...
import { faParking,faUsers, faTachometerAltFast, faGlobe, faParachuteBox, faPoll, faTransporter, faRulerTriangle, faAtom, faFileInvoice, faPaperPlane, faDraftingCompass, faCheck, faTimes, faAsterisk } from '@fal'
...
library.add(fasAsterisk, faExclamation, faInfo, faUsers, faSearch, faBell, faTachometerAltFast, faGlobe, faParachuteBox, faPoll, faTransporter, faParking, faRulerTriangle, faAtom, faFileInvoice, faPaperPlane, faDraftingCompass, faTimes, faCheck, faAsterisk)

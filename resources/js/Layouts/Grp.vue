...
import { faAsterisk as fasAsterisk, faExclamation, faInfo, faPlay } from '@fas'
...
library.add(faPauseCircle, faSunset, faSkull, fasAsterisk, faExclamation, faInfo, faPlay, faUsers, faSearch, faBell, faTachometerAltFast, faGlobe, faParachuteBox, faTransporter, faParking, faRulerTriangle, faAtom, faFileInvoice, faPaperPlane, faDraftingCompass, faTimes, faCheck, faAsterisk)

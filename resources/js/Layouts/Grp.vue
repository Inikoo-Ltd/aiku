...
import { faParking,faUsers, faTachometerAltFast, faGlobe, faParachuteBox, faTransporter, faRulerCombined } from '@fal'
import { faSearch, faBell } from '@far'
import { library } from '@fortawesome/fontawesome-svg-core'
library.add(faUsers, faSearch, faBell, faTachometerAltFast, faGlobe, faParachuteBox, faTransporter, faParking, faRulerCombined)

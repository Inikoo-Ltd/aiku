...
import { faSignOutAlt, faSensor, faLifeRing, faHeadset } from "@fal"
import { FontAwesomeIcon } from "@fortawesome/vue-fontawesome"
import { inject, ref } from "vue"
import { layoutStructure } from "@/Composables/useLayoutStructure"
import Button from "@/Components/Elements/Buttons/Button.vue"

library.add(faChevronLeft, faSignOutAlt, faSensor, faLifeRing, faHeadset)
		...
		<div class="absolute bottom-20 w-full">
			<div class="flex flex-col justify-center">
				...
				<Popover class="relative w-full" v-slot="{ open }">
					<PopoverButton
						class="flex w-full focus:outline-hidden focus:ring-0 focus:border-none px-2">

...
const bottomLinks = computed(() => [
    { route: "grp.tasks.index", parameters: {}, root: "grp.tasks.", label: ctrans("Tasks"), tooltip: ctrans("Tasks: ask a colleague or a department for something"), icon: "fal fa-tasks" },

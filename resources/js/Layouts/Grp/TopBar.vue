...
<template>
    <Disclosure id="topbar_grp" as="nav" class="fixed top-0 z-[21] w-full bg-gray-50 text-gray-700 transition-all duration-300 ease-in-out" :class="layoutStore.messagingSidebar?.show ? 'md:pr-48' : 'md:pr-12'" v-slot="{ open }">

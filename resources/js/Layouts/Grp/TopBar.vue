            ...
            <div class="flex h-11 lg:h-10 shrink-0">
                <div class="flex items-center border-b border-gray-300">
                    ...
                    <Menu v-if="layoutStore.group || (layoutStore.organisations.data?.length > 1)" as="div" class="ml-2 relative text-left">
                        <MenuButton v-slot="{ open }"
                                    class="inline-flex sm:min-w-32 sm:w-[184px] h-[26px] lg:h-8 text-ellipsis rounded-sm border border-gray-300 w-full whitespace-nowrap justify-between items-center gap-x-2 px-2.5 py-2 text-xxs font-medium focus:outline-hidden focus-visible:ring-2 focus-visible:ring-white/75"
                ...
                "
                    ...
                    "
                                ...
                                <transition>
                                    <MenuItems class="absolute left-0 mt-2 w-56 origin-top-right divide-y-0 divide-gray-400 rounded-sm bg-white shadow-lg ring-1 ring-black/5 focus:outline-hidden">
                ...
                "
                            ...
                            >
                                ...
                                <transition>
                                    <MenuItems class="absolute left-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-sm bg-white shadow-lg ring-1 ring-black/5 focus:outline-hidden">

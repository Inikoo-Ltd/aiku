...
- Each line tells the stock story at a glance — *their stock*, *our stock*, and when *we run out* — plus the amount at the partner's current price in **your organisation's currency**, with the open items' total at the foot of the table.
...
<ul>
<li><b>Add to the list:</b> your organisation → <b>Procurement → Partners</b> → open the partner → <b>Shopping list</b> → <b>Add stocks</b>, or <b>Browse</b> and set quantities on the product cards, or <b>Auto-fill</b> for a proposal.</li>
